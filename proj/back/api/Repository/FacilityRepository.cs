...
namespace api.Repository
{
    public class FacilityRepository : IFacilityRepository
    {
        ...
        public async Task<List<Facility>> GetAllAsync(QueryObjectFacility query)
        {
            ...
            if (!string.IsNullOrWhiteSpace(query.ColumnType))
            {
                facilities = facilities.Where(s => s.ColumnType.Contains(query.ColumnType));
            }
            ...
            if (!string.IsNullOrWhiteSpace(query.SortBy))
            {
                ...
                {
                    facilities = query.IsDescending ? facilities.OrderByDescending(n => n.Name) : facilities.OrderBy(n => n.Name);
                }
            }
